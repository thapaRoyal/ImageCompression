...
/**
 * Extended options for Node.js compression using Sharp
 */
export interface NodeCompressionOptions extends CompressionOptions {
  /**
   * Sharp image processing options
   */
  sharp?: {
    /**
     * Apply image sharpening during processing
     * @default false
     */
    sharpen?: boolean;

    /**
     * Remove metadata from the output image
     * @default true
     */
    stripMetadata?: boolean;

    /**
     * Compression options specific to WebP format
     */
    webp?: {
      lossless?: boolean;
    ...
    /**
     * Compression options specific to AVIF format
     */
    avif?: {
      lossless?: boolean;
      speed?: number;
